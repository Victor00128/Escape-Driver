    ...
    <div className="min-h-screen bg-[#0a0a0f] grid-bg flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div
          ...
          style={{
            background:
              "linear-gradient(to top, rgba(0,245,255,0.05) 0%, transparent 100%)",
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        <div className="mb-8 text-center">
          ...
          <p
            className="text-[#00f5ff] mt-4 text-sm tracking-[0.3em] uppercase"
        ...
        {/* Car ASCII Art */}
        <div
          className="mb-8 text-[#00f5ff] text-xs opacity-60"
   ...
   (o)   (o)
        ...
        {highScore > 0 && (
          <div className="mb-6 text-center">
            <p
              className="text-[#ffff00] text-xs tracking-widest"
              style={{ fontFamily: "'Press Start 2P', cursive" }}
            >
              HIGH SCORE
            </p>
            <p
              className="text-[#ffff00] text-2xl mt-1 neon-text-yellow"
              style={{ fontFamily: "'Press Start 2P', cursive" }}
            >
        ...
        <div className="flex flex-col gap-4 w-72">
          ...
          <button
            ...
            style={{
              ...
              color: "#ff00ff",
              boxShadow:
                "0 0 10px #ff00ff, 0 0 20px rgba(255,0,255,0.3), inset 0 0 10px rgba(255,0,255,0.1)",
            }}
          >
            <span>?</span>
        ...
        <div className="mt-12 text-center opacity-70">
          <p
            className="text-[#888899] text-xs mb-3 tracking-wider"
            style={{ fontFamily: "'Orbitron', sans-serif" }}
          >
            CONTROLES
          </p>
        ...
        {/* Footer */}
        <p
          className="mt-12 text-[#444455] text-xs tracking-wider"
          style={{ fontFamily: "'Orbitron', sans-serif" }}
        >
          © 2026 ESCAPE DRIVER
        </p>
      ...
      {showInstructions && (
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
          <div className="bg-[#0a0a0f] neon-border-cyan rounded-lg p-6 max-w-md w-full max-h-[80vh] overflow-y-auto">
            ...
            <div
              className="space-y-4 text-[#e0e0e0] text-sm"
              style={{ fontFamily: "'Orbitron', sans-serif" }}
            >
              <div>
                <h4 className="text-[#ff00ff] mb-2 font-bold">OBJETIVO</h4>
                <p className="text-[#aaaaaa] leading-relaxed">
                  Escapa de la policía el mayor tiempo posible. Recorre el mapa
                  urbano evitando ser atrapado por las patrullas.
                </p>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-1 text-[#aaaaaa]">
                  <li>
                    <span className="text-[#00f5ff]">↑ / W</span> - Acelerar
                  </li>
                  <li>
                    <span className="text-[#00f5ff]">↓ / S</span> - Frenar /
                    Reversa
                  </li>
                  <li>
                    <span className="text-[#00f5ff]">← / A</span> - Girar
                    izquierda
                  </li>
                  <li>
                    <span className="text-[#00f5ff]">→ / D</span> - Girar
                    derecha
                  </li>
                  <li>
                    <span className="text-[#00f5ff]">ESPACIO</span> - Freno de
                    mano
                  </li>
                  <li>
                    <span className="text-[#00f5ff]">P</span> - Pausar
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-1 text-[#aaaaaa]">
                  <li>
                    <span className="text-[#ffff00]">+10</span> puntos por
                    segundo
                  </li>
                  <li>
                    <span className="text-[#ffff00]">+50</span> evasión cercana
                  </li>
                  <li>
                    <span className="text-[#ffff00]">+100</span> policía
                    despistado
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <p className="text-[#aaaaaa] leading-relaxed">
                  Tienes 3 vidas. Cada colisión con la policía te quita una
                  vida. ¡Cuando pierdas todas, el juego termina!
                </p>
              </div>
            </div>
